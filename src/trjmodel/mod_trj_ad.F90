      SUBROUTINE mod_trj_ad( jpi,jpj,umod,vmod,e1u,e2v,flc, fls,   &
...
!! =========
      ...
      REAL*4, DIMENSION(jpi,jpj) :: umod,vmod,e1u,e2v
      REAL*4, DIMENSION(jpi,jpj) :: uadj,vadj
!!----------------------------------------------------------------------
!! Local declarations
!! ==================
      INTEGER :: jn,jt
...
!! =========
      ...
      REAL*4, DIMENSION(jpi,jpj) :: umod,vmod,uadj,vadj,e1u,e2v
!!----------------------------------------------------------------------
!! Local declarations
!! ==================
